...
abstract class $AppRouter extends _i13.RootStackRouter {
  ...
  final Map<String, _i13.PageFactory> pagesMap = {
    ...
    UsersRoute.name: (routeData) {
      return _i13.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i13.WrappedRoute(child: const _i11.UsersScreen()),
      );
    },
...
class UserModalRoute extends _i13.PageRouteInfo<void> {
  const UserModalRoute({List<_i13.PageRouteInfo>? children})
      : super(
          UserModalRoute.name,
          initialChildren: children,
        );
